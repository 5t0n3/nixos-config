...
# to /etc/nixos/configuration.nix instead.
{
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/b5a2d9ea-67a1-424f-bf44-b57b0947235d";
    fsType = "btrfs";
    options = ["subvol=root" "compress=zstd"];
  };

  boot.initrd.luks.devices."crypt".device = "/dev/disk/by-uuid/c79c3483-0235-44d1-90e9-fa02c768d8cb";
